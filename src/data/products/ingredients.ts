...
export const PARMEZAN = "parmezan";
...
export const SALAM_DULCE = "salam dulce";
export const SALAM_NAPOLI = "salam napoli";
export const SALAM_NAPOLI_PICANT = "salam napoli picant";
export const SALAM_NAPOLI_DULCE_PICANT = "salam napoli dulce/picant";
